...
?></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="daftarektp.php">Daftar E-KTP</a>   
                                    </li>
                            
                                    <li><a href="lihatktp.php">Lihat E-KTP</a></li>
                        ...
                        <div class="col-12">
                            <div class="hero-slides-content">
                              ...
                              <br> <br><br><br><br><br><br><br>
                                ...
                                <h2 style="color:#FF0000;" data-animation="fadeInUp" data-delay="400ms">Dinas Kependudukan <br>Pencatatan Sipil Kota Semarang</h2>
 ...
 <div class="col-12 col-sm-6 col-lg-4">
     <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="500ms">
    <div class=" bg-img" style="background-image: url(img/bg-img/bg-1.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 >All the courses you need</h4>
                                <h2 >Wellcome to our <br>Online University</h2>
