...
$jenis_pekerjaan = $_POST['jenis_pekerjaan'];
 ...
 if ($cek > 0){
    echo "<script>window.alert('Maaf , Nik yang anda masukan sudah terdaftar, Silahkan cek email !')
    window.location='../daftarektp.php'</script>";
       ...
       $sql = "INSERT INTO `dataektp`(`id`,`nik`, `kk`, `nama_lengkap`, `tmp_lahir`, `jk`, `ttl`, `provinsi`, `kabupaten`, `alamat`, `rt`, `rw`, `kelurahan`, `kecamatan`, `agama`, `statuskawin`, `jenis_pekerjaan`) VALUES (NULL, '$nik', '$kk', '$nama_lengkap', '$tmp_lahir','$jk',  '$ttl',  '$provinsi',  '$kabupaten', '$alamat', '$rt', '$rw', '$kelurahan', '$kecamatan', '$agama', '$statuskawin', '$jenis_pekerjaan')";
